      ...
      <div className="max-w-7xl mx-auto">
            ...
            {pricingData[activeTab][activeCategory].map((plan, index) => (
              ...
              >
                ...
                <div className="p-6 text-center">
                  ...
                  <Link href={"/get-funded"} className="mt-8 w-full bg-gradient-to-r from-blue-700 via-blue-500 to-blue-300 text-white px-4 py-2 rounded-md shadow hover:opacity-90 transition-opacity duration-300 cursor-pointer">
                    Get Started
                  </Link>
                </div>
              </div>
        ...
        <div className="mt-20 bg-gradient-to-r from-blue-700 via-blue-500 to-blue-300 rounded-lg shadow-xl">
          <div className="max-w-4xl mx-auto px-6 py-12 text-center">
            ...
            <div className="mt-8">
              <Link href={"/get-funded"} className="bg-white text-blue-600 px-8 py-3 rounded-md font-medium text-lg shadow-md hover:bg-gray-100 transition-colors duration-300">
                Get Started Now
              </Link>
            </div>
          </div>
